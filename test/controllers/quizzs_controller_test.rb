...
class QuizzsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quizz" do
    assert_difference("Quizz.count") do
      post quizzs_url, params: { quizz: { alcool: @quizz.alcool, sommeil: @quizz.sommeil, sport: @quizz.sport } }
    end
  ...
  test "should update quizz" do
    patch quizz_url(@quizz), params: { quizz: { alcool: @quizz.alcool, sommeil: @quizz.sommeil, sport: @quizz.sport } }
